...
** Definition: Substitution
   Here, i adn k are metavariables for distinct terms.
...
** TODO Define a function \[removenames_\Gamma(t)\] that takes a term t such that \[FV(t) \in dom(\Gamma)\] and returns corresponding nameless term.
   See [[./impl-de-Brujin][my implementation of de Brujin untyped lambda calculus]].

** TODO Define a function \[restorenames_\Gamma(t)\] that takes a de Brujin term t that produces an ordinary term from it.
   See [[./impl-de-Brujin][my implementation of de Brujin untyped lambda calculus]].
